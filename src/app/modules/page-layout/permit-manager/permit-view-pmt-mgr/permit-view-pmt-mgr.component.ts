...
import { GLOBAL_PARAM_KEY, GLOBAL_PARAM_MODE, FILTER_TYPE } from 'src/app/app-constants';
import { SAVE_AS_DRAFT_POST_ACTION, PERMIT_CONFIRMATION_DIALOG, CHANGE_REQUEST_DIALOG, REINSTATEMENT_DIALOG_MODE, PERMIT_GEOMETRY_TYPE } from 'src/app/constants/app-repo.constants';
import { WORK_STREAM, PERMIT_ACTIONS_CONFIG, MASTER_DATA, WORK_TYPE, PERMIT_STATUS, WORK_STATUS } from 'src/app/constants/db.constants';
...
import { PermitConfirmationDataModel, PermitConfirmationConfigModel } from 'src/app/modules/widget-app/create-permit-confirmation/create-permit-confirmation.model';
...
import { CreatePermitSummuryDataModel, CreatePermitSummuryConfigModel } from 'src/app/modules/widget-app/create-permit-summary/create-permit-summury.model';
...
import { CreateReinstatementSummuryDataModel, CreateReinstatementSummuryConfigModel } from 'src/app/modules/widget-app/create-reinstatement-summary/create-reinstatement-summary.model';
import { DataDiffA3Model, DataDiffA3ConfigModel } from 'src/app/modules/widget-app/data-diff/data-diff-a3/data-diff-a3-model';
import { ElginMapDataModel, ElginMapConfigModel, GeometryDataModel } from 'src/app/modules/widget-app/elginmap/elginmap-model';
...
import { FileUploadDataModel, FileUploadConfigModel } from 'src/app/modules/widget-app/file-upload/file-upload-model';
import { PermitActivityLogModel, PermitActivityLogConfigModel } from 'src/app/modules/widget-app/permit-activity-log-tab/permit-activity-log.model';
import { PermitAddCommentDataModel, PermitAddCommentConfigModel } from 'src/app/modules/widget-app/permit-add-comment/add-comment.model';
import { PermitChangeReqDataModel, PermitChangeReqConfigModel } from 'src/app/modules/widget-app/permit-change-request-tab/permit-change-request-tab.module';
import { PermitCommentsTabComponent } from 'src/app/modules/widget-app/permit-comments-tab/permit-comments-tab.component';
import { PermitCommentsDataModel, PermitCommentsConfigModel } from 'src/app/modules/widget-app/permit-comments-tab/permit-comments-tab.module';
...
import { PermitConditionsModel, PermitConditionsConfigModel, PermitConditionsItem } from 'src/app/modules/widget-app/permit-conditions-tab/permit-conditions-tab.model';
import { PermitFpnTabComponent } from 'src/app/modules/widget-app/permit-fpn-tab/permit-fpn-tab.component';
import { PermitFPNDataModel, PermitFPNConfigModel } from 'src/app/modules/widget-app/permit-fpn-tab/permit-fpn-tab.model';
...
import { PermitImagesAndFilesModel, PermitImagesAndFilesConfigModel } from 'src/app/modules/widget-app/permit-images-and-files-tab/permit-images-and-files-tab.model';
import { PermitInspectionListDataModel, PermitInspectionListConfigModel } from 'src/app/modules/widget-app/permit-inspections-tab/permit-inspection-list.model';
...
import { PermitMapDesignationModel, PermitMapDesignationConfigModel } from 'src/app/modules/widget-app/permit-map-designation-tab/permit-map-designation-tab.model';
import { PermitMapModel, PermitMapConfigModel } from 'src/app/modules/widget-app/permit-map-tab/permit-map-tab.model';
import { PermitOverviewTabComponent } from 'src/app/modules/widget-app/permit-overview-tab/permit-overview-tab.component';
import { PermitOverviewModel, PermitOverviewConfigModel } from 'src/app/modules/widget-app/permit-overview-tab/permit-overview-tab.model';
import { PermitReinstatementDataModel, PermitReinstatementConfigModel } from 'src/app/modules/widget-app/permit-reinstatement-tab/permit-reinstatement-tab-modele';
import { RaiseChangeReqConfirmationDataModel, RaiseChangeReqConfirmationConfigModel } from 'src/app/modules/widget-app/raise-change-req-confirmation/raise-change-req-confirmation.model';
...
import { ReinstatementImagesAndFilesDataModel, ReinstatementImagesAndFilesConfigModel } from 'src/app/modules/widget-app/reinstatement-images-and-files/reinstatement-images-and-files.model';
import { SiteDetailsDataModel, SiteDetailsConfigModel } from 'src/app/modules/widget-app/site-details/site-details-model';
import { ViewPermitCommentsDataModel, ViewPermitCommentConfigModel } from 'src/app/modules/widget-app/view-permit-comments/view-permit-comments.model';
import { ViewPermitFpnDataModel, ViewPermitFpnConfigModel } from 'src/app/modules/widget-app/view-permit-fpn/view-permit-fpn.module';
...
import { ViewPermitInspectionDataModel, ViewPermitInspectionConfigModel } from 'src/app/modules/widget-app/view-permit-inspection/view-permit-inspection.model';
...
import { PermitNavigationDataModel, PermitFormPageData, MapPageDataDataModel, NSGDetails, PermitConditionsPageModel } from '../permit-listing-pmt-mgr/permit-listing.model';
import { PermitViewItemsModel, PermitViewModel, PermitViewConfigModel, PermitViewDetailsModel } from './permit-view-pmt-mgr.model';
